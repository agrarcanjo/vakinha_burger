  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          // opção de conteiner ao inves de apenas ima imagem que vc consegue trabalhar o backgroud
          Container(
            width: context.screenWidth,
            height: context.percentHeight(.4),
            decoration: BoxDecoration(
              image: DecorationImage(
                // widge é instanciado pelo provider com esse argumento
          ...
          Row(
            children: [
              ...
              Container(
                ...
                height: 68,
                padding: const EdgeInsets.all(8),
                // rebuild a tela com a mudança do estado (amount)
                child: BlocBuilder<ProductDetailController, int>(
                  builder: (context, amount) {
